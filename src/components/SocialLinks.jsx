...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/mohamed-esam-me",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@memo4dev",
    icon: Instagram,
    url: "https://www.instagram.com/memo4dev/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@memo",
    icon: Youtube,
    url: "https://www.youtube.com/@memo",
    color: "#FF0000",
...
const SocialLinks = () => {
  ...
  return (
    <div className="w-full bg-surface-container/80 rounded-2xl p-6 py-8 backdrop-blur-xl border border-[#46464d]">
      <h3 className="text-xl font-semibold text-[#e0e2e6] mb-6 flex items-center gap-2">
      ...
      <div className="flex flex-col gap-4">
        ...
        <a
          ...
          className="group relative flex items-center justify-between p-4 rounded-lg 
             bg-surface-container-high/40 border border-[#46464d] overflow-hidden
             hover:border-secondary/30 transition-all duration-500"
        >
          <div
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <span className="text-lg font-bold pt-[0.2rem] text-[#e0e2e6] tracking-tight leading-none group-hover:text-secondary transition-colors duration-300">
                {linkedIn.displayName}
              </span>
              <span className="text-sm text-[#909097] group-hover:text-[#c7c5ce] transition-colors duration-300">
                {linkedIn.subText}
              </span>
            </div>
          </div>
          ...
          <ExternalLink
            className="relative w-5 h-5 text-[#909097] group-hover:text-secondary
          ...
          {[instagram, youtube].map((link) => (
            ...
            >
              ...
              <div className="flex flex-col min-w-0">
                <span className="text-sm font-bold text-[#e0e2e6] group-hover:text-secondary transition-colors duration-300">
                  {link.displayName}
                </span>
                <span className="text-xs text-[#909097] truncate group-hover:text-[#c7c5ce] transition-colors duration-300">
                  {link.subText}
                </span>
              </div>

              <ExternalLink className="w-4 h-4 text-[#909097] group-hover:text-secondary ml-auto
                                     opacity-0 group-hover:opacity-100 transition-all duration-300
